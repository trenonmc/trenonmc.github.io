let gallerythree = document.querySelector('.galleryfour')
gallerythree.addEventListener("mouseover", function(e) {
...
gallerythree.addEventListener("mouseout", function(e) {
    if (e.target.tagName == "IMG") {
